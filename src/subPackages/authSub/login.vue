...
function openAgreement(type) {
  const urls = {
    user: '/subPackages/systemSub/agreement?type=user',
    privacy: '/subPackages/systemSub/agreement?type=privacy',
  }
  safeNavigateTo(urls[type] || urls.user)
}

function goToApply() {
  safeNavigateTo('/subPackages/authSub/applySign')
}
</script>
